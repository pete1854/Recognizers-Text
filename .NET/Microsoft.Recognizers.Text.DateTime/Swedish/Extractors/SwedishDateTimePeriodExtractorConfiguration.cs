...
{
    public class SwedishDateTimePeriodExtractorConfiguration : BaseDateTimeOptionsConfiguration,
        IDateTimePeriodExtractorConfiguration
    {
        ...
        {
            SwedishTimePeriodExtractorConfiguration.PureNumFromTo,
            SwedishTimePeriodExtractorConfiguration.PureNumBetweenAnd,
        };
            ...
            : base(config)
        {
            ...
            SingleTimeExtractor = new BaseTimeExtractor(new SwedishTimeExtractorConfiguration(this));
            SingleDateTimeExtractor = new BaseDateTimeExtractor(new SwedishDateTimeExtractorConfiguration(this));
        ...
        public Regex PrepositionRegex => SwedishTimePeriodExtractorConfiguration.PrepositionRegex;

        public Regex TillRegex => SwedishTimePeriodExtractorConfiguration.TillRegex;

        public Regex TimeOfDayRegex => PeriodTimeOfDayRegex;

        public Regex SpecificTimeOfDayRegex => PeriodSpecificTimeOfDayRegex;

        public Regex PreviousPrefixRegex => SwedishDatePeriodExtractorConfiguration.PreviousPrefixRegex;

        public Regex NextPrefixRegex => SwedishDatePeriodExtractorConfiguration.NextPrefixRegex;

        public Regex FutureSuffixRegex => SwedishDatePeriodExtractorConfiguration.FutureSuffixRegex;
