...
{
    public class SwedishDateTimeParserConfiguration : BaseDateTimeOptionsConfiguration, IDateTimeParserConfiguration
    {
         ...
         : base(config)
        {
            ...
            YearRegex = SwedishDateTimeExtractorConfiguration.YearRegex;
