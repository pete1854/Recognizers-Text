...
{
    public class SwedishTimeParserConfiguration : BaseDateTimeOptionsConfiguration, ITimeParserConfiguration
    {
        ...
        public void AdjustByPrefix(string prefix, ref int hour, ref int min, ref bool hasMin)
        {
            ...
            {
                var match = SwedishTimeExtractorConfiguration.LessThanOneHour.Match(trimmedPrefix);
