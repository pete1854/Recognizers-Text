...
{
    public class SwedishHolidayParserConfiguration : BaseHolidayParserConfiguration
    {
            ...
            : base(config)
        {
            ...
            this.HolidayRegexList = SwedishHolidayExtractorConfiguration.HolidayRegexList;
